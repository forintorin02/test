  ...
  return (
    <div className="space-y-8">
      ...
      <div className={`text-center space-y-4 ${isVisible ? 'animate-fade-in-up' : 'opacity-0'}`}>
        <div className="inline-flex items-center gap-2 bg-gradient-to-r from-green-400/20 to-blue-500/20 border border-green-400/30 rounded-full px-4 py-2 hover:scale-105 transition-all duration-300 will-change-transform">
      ...
      {/* Results Overview */}
      <div className={`grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8 ${isVisible ? 'animate-fade-in-up animate-delay-200' : 'opacity-0'}`}>
        {OVERVIEW_STATS.map((stat, index) => (
          <div 
            key={index} 
            className={`bg-gradient-to-br ${stat.gradient} backdrop-blur-sm rounded-xl p-4 border ${stat.border} hover:scale-105 hover:-translate-y-2 transition-all duration-500 hover:shadow-2xl will-change-transform animate-scale-in`}
            style={{ animationDelay: `${0.3 + index * 0.1}s` }}
          >
            <div className="flex items-center gap-3 mb-2">
              <div className={`w-10 h-10 bg-gradient-to-br ${stat.color.replace('text-', 'from-')} to-${stat.color.split('-')[1]}-500 rounded-lg flex items-center justify-center hover:scale-110 transition-transform duration-300 will-change-transform`}>
      ...
      <div className="space-y-8">
        ...
        <div 
          ...
          className={`group relative cursor-pointer will-change-transform ${isVisible ? 'animate-fade-in-up animate-delay-400' : 'opacity-0'}`}
        >
          ...
          <div className="relative bg-gradient-to-br from-slate-800/95 via-gray-900/95 to-slate-900/95 backdrop-blur-xl rounded-3xl overflow-hidden border border-emerald-400/20 group-hover:border-emerald-400/60 transition-all duration-700 group-hover:scale-[1.02] hover:-translate-y-2 shadow-2xl hover:shadow-emerald-500/20">
            ...
            <div className="flex flex-col xl:flex-row min-h-[450px]">
              <div className="xl:w-3/5 p-6 sm:p-8 xl:p-12 flex flex-col justify-center relative z-10">
                <div className="flex flex-wrap items-center gap-3 mb-6">
                  <div className="inline-flex items-center gap-2 bg-gradient-to-r from-emerald-500 to-teal-500 text-white px-4 py-2 rounded-full text-sm font-bold shadow-lg hover:scale-105 transition-transform duration-300 will-change-transform">
                    <Award className="w-4 h-4" />
                    <span>Premium Success Story</span>
                  </div>
                  <div className="inline-flex items-center gap-2 bg-yellow-500/20 text-yellow-300 px-3 py-1.5 rounded-full text-xs font-semibold border border-yellow-500/30 hover:scale-105 transition-transform duration-300 will-change-transform">
                ...
                <div className="grid grid-cols-2 gap-4 mb-8">
                  <div className="bg-gradient-to-br from-emerald-500/10 to-teal-500/10 rounded-2xl p-4 border border-emerald-500/20 hover:scale-105 transition-all duration-300 will-change-transform">
                    <div className="flex items-center gap-3 mb-2">
                      <div className="w-8 h-8 bg-gradient-to-br from-emerald-400 to-teal-500 rounded-lg flex items-center justify-center hover:scale-110 transition-transform duration-300 will-change-transform">
                  ...
                  <div className="bg-gradient-to-br from-teal-500/10 to-cyan-500/10 rounded-2xl p-4 border border-teal-500/20 hover:scale-105 transition-all duration-300 will-change-transform">
                    <div className="flex items-center gap-3 mb-2">
                      <div className="w-8 h-8 bg-gradient-to-br from-teal-400 to-cyan-500 rounded-lg flex items-center justify-center hover:scale-110 transition-transform duration-300 will-change-transform">
                ...
                <button 
                  ...
                  className="inline-flex items-center gap-3 bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white font-bold px-6 py-4 rounded-2xl transition-all duration-500 transform hover:scale-105 hover:-translate-y-1 shadow-lg hover:shadow-2xl group/btn will-change-transform focus-ring"
                >
              ...
              <div className="xl:w-2/5 relative overflow-hidden">
                <div className="aspect-[4/3] xl:aspect-auto xl:h-full relative">
                  ...
                  <div className="absolute top-6 left-6">
                    <div className="bg-black/80 backdrop-blur-xl rounded-2xl px-4 py-3 border border-emerald-400/30 shadow-2xl hover:scale-105 transition-transform duration-300 will-change-transform">
                  ...
                  <div className="absolute bottom-6 right-6">
                    <div className="bg-black/80 backdrop-blur-xl rounded-2xl px-4 py-3 border border-yellow-400/30 shadow-2xl hover:scale-105 transition-transform duration-300 will-change-transform">
                      <div className="flex items-center gap-3">
        ...
        <div 
          ...
          className={`group relative cursor-pointer will-change-transform ${isVisible ? 'animate-fade-in-up animate-delay-500' : 'opacity-0'}`}
        >
          ...
          <div className="relative bg-gradient-to-br from-gray-800/90 to-gray-900/90 backdrop-blur-sm rounded-3xl overflow-hidden border border-gray-700/50 group-hover:border-blue-400/60 transition-all duration-700 group-hover:scale-[1.02] hover:-translate-y-2 shadow-2xl hover:shadow-blue-500/20">
            <div className="flex flex-col xl:flex-row-reverse min-h-[400px]">
              <div className="xl:w-2/5 relative overflow-hidden">
                <div className="aspect-[16/9] xl:aspect-auto xl:h-full relative">
                  ...
                  <div className="absolute top-6 right-6">
                    <div className="inline-flex items-center gap-2 bg-blue-500/95 text-white px-4 py-2 rounded-full text-sm font-semibold backdrop-blur-sm shadow-lg hover:scale-105 transition-transform duration-300 will-change-transform">
                  ...
                  <div className="absolute bottom-6 left-6">
                    <div className="bg-black/60 backdrop-blur-sm rounded-lg px-3 py-2 border border-blue-400/30 hover:scale-105 transition-transform duration-300 will-change-transform">
              ...
              <div className="xl:w-3/5 p-6 sm:p-8 xl:p-10 flex flex-col justify-center">
                <div className="flex flex-wrap items-center gap-3 mb-6">
                  <div className="inline-flex items-center gap-2 bg-blue-500/20 text-blue-400 px-4 py-2 rounded-full text-sm font-semibold border border-blue-500/30 hover:scale-105 transition-transform duration-300 will-change-transform">
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                  {[
                    ...
                    <div 
                      key={index} 
                      className={`text-center bg-gray-800/40 rounded-xl p-4 border border-gray-700/30 hover:scale-105 hover:-translate-y-1 transition-all duration-300 will-change-transform animate-scale-in`}
                ...
                <button 
                  ...
                  className="inline-flex items-center gap-3 text-blue-400 hover:text-blue-300 font-semibold text-base group/btn bg-blue-400/10 hover:bg-blue-400/20 px-6 py-3 rounded-xl border border-blue-400/30 hover:border-blue-400/50 transition-all duration-500 hover:scale-105 hover:-translate-y-1 will-change-transform focus-ring"
                >
      ...
      {/* Process Overview */}
      <div className={`relative ${isVisible ? 'animate-fade-in-up animate-delay-600' : 'opacity-0'}`}>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {PROCESS_STEPS.map((step, index) => (
            <div 
              key={index} 
              className={`relative group will-change-transform animate-scale-in`}
              style={{ animationDelay: `${0.7 + index * 0.1}s` }}
            >
              <div className="bg-gray-800/60 backdrop-blur-sm rounded-2xl p-6 border border-gray-700/50 group-hover:border-gray-600/50 transition-all duration-500 text-center group-hover:scale-110 hover:-translate-y-3 hover:shadow-2xl">
                <div className={`w-16 h-16 bg-gradient-to-br ${step.color} rounded-xl flex items-center justify-center mx-auto mb-4 group-hover:scale-125 transition-all duration-500 will-change-transform shadow-lg`}>
                  <step.icon className="w-8 h-8 text-white" />
                </div>
                <h5 className="font-bold text-white text-base mb-2 group-hover:text-yellow-400 transition-colors duration-300">{step.title}</h5>
